...
def username_is_valid(request: any, username: str,
                      validation_exist: bool = False) -> bool:
...
def email_is_valid(request: any, email: str,
                   validation_exist: bool = False) -> bool:
...
def register_is_valid(request: any, username: str,
                      email: str, password: str) -> bool:
    if not username_is_valid(request, username, validation_exist=True):
        return False
...
def update_profile_is_valid(request: any, profile: object,
    ...
    if not username_is_valid(
        request, username, validation_exist=username_validation_exist
    ):
        return False

    if not email_is_valid(
        request, email, validation_exist=email_validation_exist
    ):
        return False
    return True
